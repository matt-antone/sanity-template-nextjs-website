...
const Hexagon: React.FunctionComponent<IHexagonProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fontSize="144px" fill={textColor} className="font-bold text-center flex items-center justify-center">
        {number}
      </text>
    </svg>
  );
